...
export default function UserProfileInitModal({ isOpen, onClose, onSuccess, session }) {
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg shadow-blue-500/10 border border-blue-100/50 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white/80 backdrop-blur-sm border-b border-blue-100/50 px-6 py-4">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">Initialize Profile</h2>
            <button
              onClick={onClose}
          ...
          <p className="text-sm text-gray-600 mt-1">
            Please fill in the following information to continue. This information will be used for shipping samples and payments.
          </p>
        </div>
